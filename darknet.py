...
def performDetect(imagePath="data/20191114_141523.jpg", thresh=0.25, configPath="./yolo-obj.cfg",
                  weightPath="./backup/yolo-obj_best.weights", metaPath="./data/obj.data", showImage=True,
